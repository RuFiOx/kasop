...
use async_compat::tokio::time::delay_for;

use fpga_io_am1_s9::{self, common::version::MINER_TYPE_A, generic::Variant};
...
struct WorkRxFifo {
    regs: uio_async::UioTypedMapping<fpga_io_am1_s9::workrx::RegisterBlock>,
...
struct WorkTxFifo {
    regs: uio_async::UioTypedMapping<fpga_io_am1_s9::worktx::RegisterBlock>,
    uio: uio_async::UioDevice,
}
...
pub struct CommandRxTxFifos {
    regs: uio_async::UioTypedMapping<fpga_io_am1_s9::command::RegisterBlock>,
    uio: uio_async::UioDevice,
}
...
pub struct Common {
    ...
    regs: uio_async::UioTypedMapping<fpga_io_am1_s9::common::RegisterBlock>,
...
impl Common {
    ...
    fn set_ip_core_midstate_count(
        &self,
        value: fpga_io_am1_s9::common::ctrl_reg::MIDSTATE_CNT_A,
    ) {
        self.regs
            .ctrl_reg
